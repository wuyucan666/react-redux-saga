  ...
  if( data.createType == 1 || data.createType == 2 ){
    return (
      <div style={styles.oper}>
       <Link target="_blank" style={styles.link}  to={`/Activity/ShootDetails?nickname=${data.nickname}&mobile=${data.mobile}&uuid=${data.uuid}`}  >
          查看
        </Link>
    ...
    return (
      ...
      <IceContainer title="数据列表" >
        ...
        >
          ...
          <Table.Column title="送拍用户" dataIndex="nickname" width={100} />
          <Table.Column title="送拍账号" dataIndex="mobile" width={200}  />
          <Table.Column title="送拍拍品总数" dataIndex="colCount" width={200}  />
          <Table.Column title="送拍次数" dataIndex="orderCount" width={100} />
          <Table.Column title="获奖数量" dataIndex="rewards" width={200} />
          <Table.Column title="活动礼品" dataIndex="type" width={200}  cell={ShootType}/>
          <Table.Column title="奖品状态" dataIndex="createType" width={200}  cell={ShootCreateType}/>
          <Table.Column title="奖品渠道" dataIndex="channel" width={200}  cell={ShootChannel}/>
