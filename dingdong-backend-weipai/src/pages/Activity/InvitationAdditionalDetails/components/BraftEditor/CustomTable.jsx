  ...
  return (
    <div>
      ...
      <Row wrap gutter="20" style={styles.formRow}>
        ...
        <Col l="24">
          <div style={styles.formItem}>
            <span style={styles.formLabel}>额外奖励：</span>
            PMG礼品 抽奖券   
          </div>
        </Col>
        </Row>
        ...
        <Col l="24">
          <div style={styles.formItem}>
            <span style={styles.formLabel}>完成交易总人数：</span>
            {props.countInfo == null ? '':props.countInfo.TradeTotal}
          </div>
        </Col>
        </Row>
        <Row wrap gutter="20" style={styles.formRow}>
        <Col l="24">
          <div style={styles.formItem}>
            ...
            +{props.countInfo == null ? '':props.countInfo.couponTotal}抽奖券
          </div>
        </Col>
        </Row>
        {/* <Row wrap gutter="20" style={styles.formRow}>
    ...
    <IceContainer title="奖励列表">
      ...
      >
        ...
        <Table.Column title="订单编号" dataIndex="orderSn"  width={150} />
        <Table.Column title="成交时间" dataIndex="created"  width={150} cell={renderTime}/>
