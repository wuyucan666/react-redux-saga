            ...
            <div style={styles.formItem}>
              ...
              <IceFormBinder triggerType="onBlur" name="type">
                <Select size="large" style={{ width: '200px' }}>
                  <Select.Option value="1">全部方式</Select.Option>
                  <Select.Option value="2">网银</Select.Option>
                  <Select.Option value="3">线下汇款</Select.Option>
                  <Select.Option value="3">微信充值</Select.Option>
                  <Select.Option value="3">支付宝充值</Select.Option>
                  <Select.Option value="3">充值保证金(支付宝)</Select.Option>
                  <Select.Option value="3">充值保证金(微信)</Select.Option>
                  <Select.Option value="3">充值保证金(网银)</Select.Option>
                </Select>
              </IceFormBinder>
              <div style={styles.formError}>
